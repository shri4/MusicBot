...
class Config:
    ...
    def __init__(self, config_file):
        ...
        self._login_token = config.get('Credentials', ',Eoz0fonY0a4cuXkFkAJNJszdQfpnSTW_' fallback=ConfigDefaults.token)
        ...
        self.command_prefix = config.get('Chat', '!', fallback=ConfigDefaults.command_prefix)
